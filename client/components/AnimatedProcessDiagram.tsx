...
export function AnimatedProcessDiagram({
  ...
  const processSteps: ProcessStep[] = [
    ...
    },
    {
      ...
      title: "AI Analysis",
      description:
        "Advanced content analysis and learning structure generation",
    ...
    },
    {
      ...
      description:
        "Dynamic game and simulation generation from analyzed content",
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      setCurrentStep((prev) => {
        ...
        setTimeout(() => {
          setShowOutputs((outputs) =>
            outputs.includes(next) ? outputs : [...outputs, next],
          );
        }, 1000);
    ...
    <div className={cn("bg-white rounded-2xl shadow-2xl p-8", className)}>
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-6">
          Watch your documents transform into engaging, interactive learning
          experiences through our AI-powered process
        </p>
      ...
      <div className="sr-only">
        <p>
          ...
          Step 1 - Document Upload with support for multiple formats, Step 2 -
          AI Analysis for content extraction and structure mapping, Step 3 -
          Interactive Content generation including games and simulations, Step 4
          - Gamified Learning Experience with progress tracking and
          achievements. Use the play/pause controls to control the animation, or
          click on individual steps to explore details.
        </p>
      </div>
    </div>
  );
