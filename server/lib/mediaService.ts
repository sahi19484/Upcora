...
export function extractKeyConceptsFromText(text: string): string[] {
  ...
  const stopWords = new Set([
    'this', 'that', 'with', 'have', 'will', 'from', 'they', 'been', 'were', 'their',
    'said', 'each', 'which', 'more', 'very', 'what', 'know', 'just', 'first', 'also',
    'after', 'back', 'other', 'many', 'than', 'then', 'them', 'these', 'some', 'her',
    'would', 'make', 'like', 'into', 'him', 'has', 'two', 'more', 'go', 'no', 'way',
    'could', 'my', 'than', 'first', 'water', 'been', 'call', 'who', 'its', 'now',
...
export function generateMediaSearchQueries(text: string, maxQueries: number = 3): string[] {
...
export async function searchMediaContent(text: string): Promise<MediaSearchResult> {
...
export async function searchImagesFromAPI(query: string): Promise<MediaContent[]> {
...
export async function searchVideosFromAPI(query: string): Promise<MediaContent[]> {
...
export async function generateEducationalVisuals(concept: string): Promise<MediaContent[]> {
